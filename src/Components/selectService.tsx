...
//       `${import.meta.env.VITE_API_BASE_URL}${import.meta.env.VITE_TABLES_ENDPOINT}`,
//       {
//         headers: {
...
//         `${import.meta.env.VITE_API_BASE_URL}${import.meta.env.VITE_CART_ADD_ENDPOINT}`,
//         cartData,
//         {
//           headers: {
...
//         `${import.meta.env.VITE_API_BASE_URL}${import.meta.env.VITE_RESERVATIONS_SET_ORDER}`,
//         orderData,
//         {
//           headers: {
//             "Content-Type": "application/json",
...
function SelectService() {
  ...
  const handlePayment = async () => {
    ...
    try {
      const cartResponse = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}${import.meta.env.VITE_CART_ADD_ENDPOINT_MULTIPLE}`,
        cartData,
        {
          headers: {
            "Content-Type": "application/json",
